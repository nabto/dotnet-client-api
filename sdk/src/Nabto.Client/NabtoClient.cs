...
namespace Nabto.Client
{
	...
	public partial class NabtoClient : INabtoClient, IDisposable
	{
		...
		public NabtoClient(bool callStartup)
		{
			...
			HomeDirectory = null; // set correct directory
		...
		public Version Version
		{
			...
			{
#if NETFX_CORE
				var assembly = typeof(NabtoClient).GetTypeInfo().Assembly;
#elif WINDOWS_PHONE
				var assembly = typeof(NabtoClient).GetType().Assembly;
#else
		...
		public DateTime BuildDate
		{
			get
			{
				...
				var assembly = typeof(NabtoClient).GetTypeInfo().Assembly;
#elif WINDOWS_PHONE
				var assembly = typeof(NabtoClient).Assembly;
#else
                var assembly = typeof(NativeLibrary).GetTypeInfo().Assembly;
#endif
